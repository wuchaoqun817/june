...
/**
 * 二维码工具类 Title: QRCodeUtil.java Description: Copyright: Copyright (c) 2016
 * Company:
 * 
 * @author zhoulin.zhu 2016-8-8上午11:22:16
 */
...
public class QRCodeUtil {
	...
	public static String encode(String content, String logoPath,
		...
		String fileName = time + new Random().nextInt(99999999) + "."
				+ FORMAT.toLowerCase();
	...
	public static String encode(String content, String logoPath,
		...
		fileName = fileName.substring(
				0,
				fileName.indexOf(".") > 0 ? fileName.indexOf(".") : fileName
						.length())
				+ "." + FORMAT.toLowerCase();
		ImageIO.write(image, FORMAT, new File(destPath + "/" + fileName));
		return fileName;
	...
	public static void main(String[] args) throws Exception {
		String text = "{'uri':'http://www.baidu.com','name':'peck','age':24}";

		// 不含Logo
		String fileName = QRCodeUtil.encode(text, null, "e:\\", true);
		System.out.println("二维码名称：" + fileName);
		// 含Logo，不指定二维码图片名
		// QRCodeUtil.encode(text, "e:\\csdn.jpg", "e:\\", true);
		// 含Logo，指定二维码图片名
		// QRCodeUtil.encode(text, "e:\\csdn.jpg", "e:\\", "qrcode", true);
		// 解析
		String str = QRCodeUtil.decode("e:\\" + fileName);
